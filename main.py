...
Index('ix_perf_query', Profile.gender, Profile.age, Profile.country_id)
...
# FIX: Added POST endpoint for Bot Seeding
...
async def get_profiles(
    ...
    # Requirement: Invalid sort_by returns specific error
